...
public class GoogleAddPlace {
	...
	public static void main(String[] args) {
		...
		AddPlaceResponsePayload response = given().queryParam("key", "qaclick123").body(AP).header("Content-Type", "application/json")
						.when().post("/maps/api/place/add/json")
						.then().log().all().statusCode(200).extract().as(AddPlaceResponsePayload.class);
